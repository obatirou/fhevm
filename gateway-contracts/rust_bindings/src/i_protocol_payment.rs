...
```*/
                ...
                },
                {
                    fn sendFeesToBurner(
                        ...
                        <sendFeesToBurnerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IProtocolPaymentCalls::sendFeesToBurner)
                    }
                    sendFeesToBurner
                },
                {
    ...
    impl IProtocolPaymentErrors {
        ...
        ///
        /// Prefer using `SolInterface` methods instead.
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[68u8, 107u8, 115u8, 116u8]];
    }
    #[automatically_derived]
            ...
            ) -> alloy_sol_types::Result<IProtocolPaymentErrors>] = &[
                {
                    fn SendFeesToBurnerFailed(
                        ...
                        <SendFeesToBurnerFailed as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(IProtocolPaymentErrors::SendFeesToBurnerFailed)
                    }
