...
| `INPUT_VERIFICATION_PRICE`          | Price of an input verification             | address       | -                                                                                                   | The price is in $ZAMA and uses 18 decimals                                       |
| `PUBLIC_DECRYPTION_PRICE`           | Price of a public decryption               | address       | -                                                                                                   | The price is in $ZAMA and uses 18 decimals                                       |
| `USER_DECRYPTION_PRICE`             | Price of a user decryption                 | address       | -                                                                                                   | The price is in $ZAMA and uses 18 decimals                                       |
